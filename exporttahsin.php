...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query untuk mengambil data dari tabel tahsin berdasarkan rentang tanggal
    $query = "SELECT tahsin.*, 
                     unit.nama_unit, 
                     surah.nama_surah, 
                     juz.juz,
              ...
              LEFT JOIN pegawai ON tahsin.id_pegawai = pegawai.id_pegawai
              LEFT JOIN ustad ON tahsin.id_ustad = ustad.id_ustad
              WHERE tahsin.tanggal BETWEEN '$start_date' AND '$end_date'";
} else {
    // Query untuk mengambil semua data dari tabel tahsin
    $query = "SELECT tahsin.*, 
                     unit.nama_unit, 
                     surah.nama_surah, 
                     juz.juz,
...
if ($result) {
    // Ambil data satu per satu dan simpan ke dalam array $tahsinData
