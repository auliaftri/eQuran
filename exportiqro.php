...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query untuk mengambil data dari tabel iqro berdasarkan rentang tanggal
    $query = "SELECT iqro.*, 
                     unit.nama_unit,
                     ustad.nama_ustad
              FROM iqro
              ...
              WHERE iqro.tanggal BETWEEN '$start_date' AND '$end_date'";
} else {
    // Query untuk mengambil semua data dari tabel iqro
    $query = "SELECT iqro.*, 
                     unit.nama_unit, 
                     ustad.nama_ustad
              FROM iqro
...
if ($result) {
    // Ambil data satu per satu dan simpan ke dalam array $iqroData
    ...
    <table id="datatablesSimple" class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo htmlspecialchars($data['halaman']); ?></td>
